...
<div style="margin:80px;" class="globalrow">
  ...
  <div class="curriculamcol" id="syllabus">
    ...
    <div class="container">
      ...
      <p class="font4">The curriculum has been designed by faculty from Amruta Experts 
...
<div class="livepro_col" id="projects">
  ...
  <div class="cases usecase" id="usecase">
    ...
    <div class="container">
      ...
      <div role="tabpanel" class="tabpanel">
        ...
        <!-- Nav tabs -->
        <ul class="nav nav-tabs nav" role="tablist">
          <li style=" font-family:Poppins" role="presentation"><a href="#financial" aria-controls="financial" role="tab"
              data-toggle="tab" class="active">Financial<br>services</a></li>
          <li style=" font-family:Poppins" role="presentation"><a href="#health" aria-controls="health" role="tab"
              data-toggle="tab">Health care</a></li>
          <li style=" font-family:Poppins" role="presentation"><a href="#ecommerce" aria-controls="ecommerce" role="tab"
              data-toggle="tab">E-commerce & Hi-Tech</a></li>
          <li style=" font-family:Poppins" role="presentation"><a href="#travel" aria-controls="travel" role="tab"
  ...
  <div class="container">
    ...
    <div class="gtcol">
      ...
      <div class="row">
        <div class="col-md-8">
          <h4>Learn from <span style= "font-size:55px">#1</span> Ranked Artificial Intelligence <br> Program and
